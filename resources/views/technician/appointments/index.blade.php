                ...
                <div class="p-6">
                    ...
                    <div class="space-y-2 mb-4">
                        <div class="flex items-center gap-2">
                            ...
                            <p class="text-sm text-gray-700">{{ $appointment->caseOrder->clinic->clinic_name }}</p>
                        </div>
                        <div class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <p class="text-sm text-gray-700">{{ $appointment->caseOrder->case_type }}</p>
                        </div>
                        <div class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <p class="text-sm text-gray-700">{{ $appointment->schedule_datetime->format('M d, Y h:i A')
                                }}</p>
                        </div>
                    </div>

                    <div class="border-t pt-4 flex justify-between items-center">
                        <p class="text-xs text-gray-500">{{ $appointment->materialUsages->count() }} material(s) used
                        </p>
