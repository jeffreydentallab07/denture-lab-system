    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <p class="text-3xl font-bold text-green-600 mt-2">{{ $completedAppointments->total() }}</p>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-800">{{ $appointment->caseOrder->case_type
                                        }}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500">Patient</p>
                                    <p class="text-sm font-medium text-gray-800">{{
                                        $appointment->caseOrder->patient->name ?? 'N/A' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <span
                                        ...
                                        {{ $usage->material->material_name }} ({{ $usage->quantity_used }} {{
                                        $usage->material->unit }})
                                    </span>
                                    @endforeach
                                </div>
                            ...
                            <div class="flex items-center gap-4 text-xs text-gray-500">
                                <div class="flex items-center gap-1">
                                    ...
                                    <span>Scheduled: {{ $appointment->schedule_datetime->format('M d, Y h:i A')
                                        }}</span>
                                </div>
                                <div class="flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span>Completed: {{ $appointment->updated_at->format('M d, Y h:i A') }}</span>
                                </div>
                            </div>
                        </div>
