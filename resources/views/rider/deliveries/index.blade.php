...
<div class="p-6 bg-gray-100 min-h-screen">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600">Manage all your delivery assignments</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <p class="text-3xl font-bold text-orange-600 mt-2">{{ $totalDeliveries }}</p>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-gray-500 text-sm font-medium">Ready to Deliver</h3>
                <p class="text-3xl font-bold text-yellow-600 mt-2">{{ $pendingDeliveries }}</p>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-gray-500 text-sm font-medium">In Transit</h3>
                <p class="text-3xl font-bold text-blue-600 mt-2">{{ $inTransit }}</p>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-gray-500 text-sm font-medium">Delivered</h3>
                <p class="text-3xl font-bold text-green-600 mt-2">{{ $completedDeliveries }}</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow mb-6">
            <div class="p-6 border-b bg-gradient-to-r from-orange-50 to-orange-100">
                <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                    ...
                    Today's Deliveries ({{ $todayDeliveries->count() }})
                </h2>
                <p class="text-sm text-gray-600 mt-1">Priority deliveries scheduled for today</p>
            </div>
            <div class="p-6">
                <div class="space-y-4">
                    ...
                    <div class="border-l-4 
                        ...
                        pl-4 py-4 rounded-r-lg shadow-sm hover:shadow-md transition">
                        <div class="flex justify-between items-start">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-2">
                                    <span class="font-bold text-lg text-gray-800">{{
                                        $delivery->appointment->caseOrder->clinic->clinic_name }}</span>
                                    <span
                                ...
                                <div class="space-y-1 text-sm text-gray-600">
                                    <p class="flex items-center gap-2">
                                        ...
                                        {{ $delivery->appointment->caseOrder->clinic->address ?? 'N/A' }}
                                    </p>
                                    <p class="flex items-center gap-2">
                                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                            ...
                            <div class="flex flex-col gap-2 ml-4">
                                ...
                                <button onclick="updateDeliveryStatus({{ $delivery->delivery_id }}, 'in transit')"
                                    class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-semibold transition flex items-center gap-2">
                                ...
                                <a href="{{ route('rider.deliveries.show', $delivery->delivery_id) }}"
                                    class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 text-sm font-semibold text-center transition">
                                    View Details
                                </a>
                            </div>
                        </div>
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="p-6 border-b flex justify-between items-center">
                <h2 class="text-xl font-bold text-gray-800">All Deliveries History</h2>
                <div class="flex gap-2">
                    <button onclick="filterDeliveries('all')"
                        class="px-4 py-2 text-sm bg-orange-500 text-white rounded-lg hover:bg-orange-600 filter-btn active transition">
                        All
                    </button>
